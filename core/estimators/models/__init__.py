...
zoo = {
    ...
    'omar': OmarCNN(),
    'resnet18': resnet18(1),
    'microresnet#2-gate=3x3-n=2-se=False': MicroResnet.micro2(1,
                                                             n=2,
                                                             encoder=Encoder3x3,
    ...
    'microresnet#4-gate=3x3-n=1-se=False': MicroResnet.micro(1,
                                                             n=1,
                                                             encoder=Encoder3x3,
                                                             blocks=[BasicBlock, BasicBlock,
                                                                     BasicBlock],
                                                             preactivate=True,
                                                             activation='leaky_relu'),
    'microresnet#5-gate=5x5-n=1-se=True': MicroResnet.micro5(1,
                                                             n=1,
                                                             encoder=Encoder5x5,
    ...
    'microresnet#4-gate=7x7-n=1-se=True': MicroResnet.micro(1,
                                                            ...
                                                            preactivate=True,
                                                            activation='leaky_relu'),
    'microresnet#4-gate=5x5-n=2-se=False': MicroResnet.micro(1,
                                                            n=2,
                                                            encoder=Encoder5x5,
                                                            blocks=[BasicBlock, BasicBlock, BasicBlock],
                                                            preactivate=True,
