...
\begin{figure}[H]
  ...
  \end{figure}
  All the strees where label as traversble, while the roofs depend on the orientation. For example, form Krock's point of view, most steep roofs are not traversble when walking up hill. On the other hand, if krock walk side by side they can be traverse. The following figure shows this behaviour on the church's roof.
  \begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
