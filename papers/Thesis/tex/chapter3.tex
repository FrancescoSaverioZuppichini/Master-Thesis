...
\begin{figure}[H]
	...
	\caption{\emph{Preactivation}}
\end{figure}
We select \emph{ResNet} architecure similar to the ones originally proposed to fit the \emph{CIFAR10} \cite{cifar} dataset. We used a initial features size of $64$ with three blocks of depth $n=1$. The final model has \todo{add learnable parameters}
