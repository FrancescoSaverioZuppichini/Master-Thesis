...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{img/implementation/estimator/resnet_block.png}
...
Following the recent work of He et al. \cite{he2015identity} we adopt \emph{pre-activation} in each block. \emph{Pre-activation} just reverse the order of the operation in a block.
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{img/implementation/estimator/preactivation.png}
	\caption{\emph{Preactivation}}
	\end{figure}
To conclude, we also used the \emph{Squeeze and Excitation operator} \cite{hu2017squeeze} a form of attention that weights the channel of each convolutional operation. The next figure visualize the idea.
\begin{figure}[H]
	\centering
