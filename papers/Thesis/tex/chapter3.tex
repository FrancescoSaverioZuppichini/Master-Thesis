...
We evaluated $n=[1,2], d=3$ with and without SE module all with a starting channel size of $16$ and finally select $n=1$ and $d=3$, we called this model architecture \emph{micro-resnet}. 
...
\end{table}
\todo[inline]{missing the two head}
