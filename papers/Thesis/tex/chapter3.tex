...
\begin{figure}[H]
    ...
    \caption{Simplex Noise on flat ground. The feature size corespond to the amount of noise we introduce in the surface. A lower value will produce rocky grounds, while a bigger one bumps.}    
\end{figure}
