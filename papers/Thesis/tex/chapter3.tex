...
\todo[inline]{figure that shows Krock somewhere with the patch bounding boxed}. 
...
We called this model architecture \emph{MicroResNet}. 
...
Our models have approximately $35$ times less parameters than the smalles ResNet model, ResNet18, that has $11M$ parameters. To simplicity we will use the following notation to describe each architecture variant: \texttt{MicroResNet-{3x3/7x7}-{/SE}}.
