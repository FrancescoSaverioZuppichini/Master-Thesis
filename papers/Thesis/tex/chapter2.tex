...
\begin{figure}[H]
    	\begin{subfigure}[b]{0.3\textwidth}
			\includegraphics[width=\textwidth]{img/bars1.png}
			\caption{\emph{bars1}}
	    \end{subfigure}
		\begin{subfigure}[b]{0.3\textwidth}
			\includegraphics[width=\textwidth]{img/slope_rocks2.png}
			\caption{\emph{slope rocks 2}}
	    \end{subfigure}	
	   \begin{subfigure}[b]{0.3\textwidth}
			\includegraphics[width=\textwidth]{img/steps1.png}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{img/bars1-3d.png}
	\label{fig: bars1-3d}
