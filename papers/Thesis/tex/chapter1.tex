...
We can also distinguish between different types of robots: wheel and no-wheel. Since previous work \cite{omar2018traversability} has been focused on wheel robot, we are now interested in no-wheel robots and in particular in legged robot.
